...
import type { AuthUser, MeResponse } from "@/shared/types/auth.types";
...
vi.mock("./RegisterForm", () => ({ RegisterForm: ({ onSuccess }: RegisterFormProps) => <button onClick={() => onSuccess?.({ taxNumber: "12345676", companyName: "Company", shortName: "Company", postalCode: null, city: null, streetAddress: null, fullAddress: "", status: "VALID", incorporationDate: null })}>Complete registration</button> }));
