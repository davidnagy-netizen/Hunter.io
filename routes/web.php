 ...
 *
 * Every page — landing, sign-in, the app, the admin console — is the React app in `frontend/`, which routes on the
 ...
 * Build it with `npm --prefix frontend run build` (output: `public/spa`).
 */
